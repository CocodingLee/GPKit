...
// 拖曳view的方向
typedef NS_ENUM(NSInteger, GPDragDirection) {
    GPDragDirectionAny,          /**< 任意方向 */
    GPDragDirectionHorizontal,   /**< 水平方向 */
    GPDragDirectionVertical,     /**< 垂直方向 */
};

@interface GPDragView : UIView
/**
 是不是能拖曳，默认为YES
 YES，能拖曳
 NO，不能拖曳
...
/**
 拖曳的方向，默认为any，任意方向
 */
@property (nonatomic,assign) GPDragDirection dragDirection;
...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(GPDragView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(GPDragView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(GPDragView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(GPDragView *dragView);
@end
