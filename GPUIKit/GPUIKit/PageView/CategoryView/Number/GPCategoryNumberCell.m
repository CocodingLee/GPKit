...
#import "GPCategoryNumberCell.h"
#import "GPCategoryNumberCellModel.h"

@interface GPCategoryNumberCell ()

@end

@implementation GPCategoryNumberCell
...
- (void)layoutSubviews {
    ...
    GPCategoryNumberCellModel *myCellModel = (GPCategoryNumberCellModel *)self.cellModel;
