//
//  GPCategoryIndicatorParamsModel.h
//  GPCategoryView
//
 ...
 */
@interface GPCategoryIndicatorParamsModel : NSObject
...
@property (nonatomic, assign) GPCategoryCellSelectedType selectedType;  //cell被选中类型
@end
