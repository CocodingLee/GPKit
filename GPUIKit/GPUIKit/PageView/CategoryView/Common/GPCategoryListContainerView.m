...
#import "GPCategoryListContainerView.h"

@interface GPCategoryListContainerView ()
@property (nonatomic, weak) id<GPCategoryListContainerViewDelegate> delegate;
@property (nonatomic, weak) UIViewController *parentViewController;
@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, strong) NSMutableDictionary <NSNumber *, id<GPCategoryListContentViewDelegate>> *validListDict;
@property (nonatomic, assign) BOOL isLayoutSubviewsed;
@end

@implementation GPCategoryListContainerView

- (instancetype)initWithParentVC:(UIViewController *)parentVC delegate:(id<GPCategoryListContainerViewDelegate>)delegate {
...
- (void)reloadData {
    for (id<GPCategoryListContentViewDelegate> list in _validListDict.allValues) {
...
- (void)layoutSubviews {
    ...
    self.scrollView.contentSize = CGSizeMake(self.scrollView.bounds.size.width*[self.delegate numberOfListsInlistContainerView:self], self.scrollView.bounds.size.height);
    [_validListDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull index, id<GPCategoryListContentViewDelegate>  _Nonnull list, BOOL * _Nonnull stop) {
...
#pragma mark - GPCategoryBaseView回调
...
- (void)listDidAppear:(NSInteger)index {
    ...
    id<GPCategoryListContentViewDelegate> list = _validListDict[@(index)];
    if (list == nil) {
