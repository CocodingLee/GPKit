...
#import "GPCategoryTitleCell.h"
#import "GPCategoryTitleCellModel.h"

@interface GPCategoryTitleCell ()
@property (nonatomic, strong) CALayer *maskLayer;

@end

@implementation GPCategoryTitleCell
...
- (void)reloadData:(GPCategoryBaseCellModel *)cellModel {
    ...
    GPCategoryTitleCellModel *myCellModel = (GPCategoryTitleCellModel *)cellModel;
