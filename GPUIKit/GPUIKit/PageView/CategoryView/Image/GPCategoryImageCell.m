...
#import "GPCategoryImageCell.h"
#import "GPCategoryImageCellModel.h"

@interface GPCategoryImageCell()
@property (nonatomic, strong) NSString *currentImageName;
@property (nonatomic, strong) NSURL *currentImageURL;
@end

@implementation GPCategoryImageCell
...
- (void)layoutSubviews {
    ...
    GPCategoryImageCellModel *myCellModel = (GPCategoryImageCellModel *)self.cellModel;
