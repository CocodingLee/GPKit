...
@interface GPPagerListContainerView() <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) GPPagerListContainerCollectionView *collectionView;
@end

@implementation GPPagerListContainerView

- (instancetype)initWithDelegate:(id<GPPagerListContainerViewDelegate>)delegate {
...
- (void)initializeViews {
    ...
    _collectionView = [[GPPagerListContainerCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
...
@interface GPPagerListContainerCollectionView ()

@end

@implementation GPPagerListContainerCollectionView
