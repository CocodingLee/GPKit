...
- (void)hookAddObserver:(NSObject *)observer
                ...
                context:(void *)context
{
    ...
    gp_swizzleDeallocIfNeeded(self.class);
    gp_swizzleDeallocIfNeeded(observer.class);
}

- (void)hookRemoveObserver:(NSObject *)observer
                forKeyPath:(NSString *)keyPath
                   context:(void*)context
{
    if ([self ignoreKVOInstanceClass:observer]) {
